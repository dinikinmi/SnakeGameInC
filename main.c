...
SetConsoleTitle("Advanced C tutorial");
// Set up the required window size:

COORD bufferSize = {x_asix_length+20,y_asix_length+20};
SetConsoleScreenBufferSize(g_consoleHandle, bufferSize);

SMALL_RECT windowSize = {0, 0,x_asix_length+10,y_asix_length+10};
int ifSuccess=SetConsoleWindowInfo(g_consoleHandle, 1, &windowSize);
...
//printf("test initialize 0 \n");
 ...
 g_head_dog_pointer=(*g_dog_manager.make_a_dog_queue)(10,3,5,10);
